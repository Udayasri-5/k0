...
! /root/k0/egs/Capstone_ASR/utils/validate_dict_dir.pl $srcdir && \
...
if ! /root/k0/egs/Capstone_ASR/utils/validate_dict_dir.pl $srcdir >&/dev/null; then
  /root/k0/egs/Capstone_ASR/utils/validate_dict_dir.pl $srcdir  # show the output.
...
if [ ! -z "$extra_word_disambig_syms" ]; then
  if ! /root/k0/egs/Capstone_ASR/utils/lang/validate_disambig_sym_file.pl --allow-numeric "false" $extra_word_disambig_syms; then
...
if $share_silence_phones; then
  ...
  cat $srcdir/silence_phones.txt | awk '{printf("%s ", $0); } END{printf("\n");}' | cat - $srcdir/nonsilence_phones.txt | \
    /root/k0/egs/Capstone_ASR/utils/apply_map.pl $tmpdir/phone_map.txt > $dir/phones/sets.txt
  ...
  cat $srcdir/{,non}silence_phones.txt | /root/k0/egs/Capstone_ASR/utils/apply_map.pl $tmpdir/phone_map.txt > $dir/phones/sets.txt
  cat $dir/phones/sets.txt | awk '{print "shared", "split", $0;}' > $dir/phones/roots.txt
fi

cat $srcdir/silence_phones.txt | /root/k0/egs/Capstone_ASR/utils/apply_map.pl $tmpdir/phone_map.txt | \
  awk '{for(n=1;n<=NF;n++) print $n;}' > $dir/phones/silence.txt
cat $srcdir/nonsilence_phones.txt | /root/k0/egs/Capstone_ASR/utils/apply_map.pl $tmpdir/phone_map.txt | \
...
cat $srcdir/extra_questions.txt 2>/dev/null | /root/k0/egs/Capstone_ASR/utils/apply_map.pl $tmpdir/phone_map.txt \
...
if [ ! -z "$unk_fst" ]; then  # if the --unk-fst option was provided...
  if "$silprob"; then
    /root/k0/egs/Capstone_ASR/utils/lang/internal/modify_unk_pron.py $tmpdir/lexiconp_silprob.txt "$oov_word" || exit 1
  else
    /root/k0/egs/Capstone_ASR/utils/lang/internal/modify_unk_pron.py $tmpdir/lexiconp.txt "$oov_word" || exit 1
  fi
...
if "$silprob"; then
  ndisambig=$(/root/k0/egs/Capstone_ASR/utils/add_lex_disambig.pl $unk_opt --pron-probs --sil-probs $tmpdir/lexiconp_silprob.txt $tmpdir/lexiconp_silprob_disambig.txt)
else
  ndisambig=$(/root/k0/egs/Capstone_ASR/utils/add_lex_disambig.pl $unk_opt --pron-probs $tmpdir/lexiconp.txt $tmpdir/lexiconp_disambig.txt)
fi
...
if [ -f $srcdir/nonterminals.txt ]; then
  /root/k0/egs/Capstone_ASR/utils/lang/grammar/augment_phones_txt.py $dir/phones.txt $srcdir/nonterminals.txt $dir/phones.txt
  /root/k0/egs/Capstone_ASR/utils/lang/grammar/augment_words_txt.py $dir/words.txt $srcdir/nonterminals.txt $dir/words.txt
  cp $srcdir/nonterminals.txt $dir/phones/nonterminals.txt
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/nonterminals.txt >$dir/phones/nonterminals.int
  ...
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/left_context_phones.txt >$dir/phones/left_context_phones.int
...
cat $dir/phones/align_lexicon.txt |  /root/k0/egs/Capstone_ASR/utils/sym2int.pl -f 3- $dir/phones.txt | \
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl -f 1-2 $dir/words.txt > $dir/phones/align_lexicon.int
...
if $silprob; then
  ...
  /root/k0/egs/Capstone_ASR/utils/lang/make_lexicon_fst_silprob.py $grammar_opts --sil-phone=$silphone \
         $tmpdir/lexiconp_silprob.txt $srcdir/silprob.txt | \
     fstcompile --isymbols=$dir/phones.txt --osymbols=$dir/words.txt \
       --keep_isymbols=false --keep_osymbols=false |   \
     fstarcsort --sort_type=olabel > $dir/L.fst || exit 1;
else
  /root/k0/egs/Capstone_ASR/utils/lang/make_lexicon_fst.py $grammar_opts --sil-prob=$sil_prob --sil-phone=$silphone \
            $tmpdir/lexiconp.txt | \
    fstcompile --isymbols=$dir/phones.txt --osymbols=$dir/words.txt \
      --keep_isymbols=false --keep_osymbols=false | \
    fstarcsort --sort_type=olabel > $dir/L.fst || exit 1;
...
cat $dir/oov.txt | /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/words.txt >$dir/oov.int || exit 1;
...
/root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/wdisambig.txt >$dir/phones/wdisambig_phones.int
/root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/words.txt <$dir/phones/wdisambig.txt >$dir/phones/wdisambig_words.int
...
for f in silence nonsilence optional_silence disambig context_indep; do
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/$f.txt >$dir/phones/$f.int
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/$f.txt | \
   awk '{printf(":%d", $1);} END{printf "\n"}' | sed s/:// > $dir/phones/$f.csl || exit 1;
done

for x in sets extra_questions; do
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl $dir/phones.txt <$dir/phones/$x.txt > $dir/phones/$x.int || exit 1;
done

/root/k0/egs/Capstone_ASR/utils/sym2int.pl -f 3- $dir/phones.txt <$dir/phones/roots.txt \
   > $dir/phones/roots.int || exit 1;

if [ -f $dir/phones/word_boundary.txt ]; then
  /root/k0/egs/Capstone_ASR/utils/sym2int.pl -f 1 $dir/phones.txt <$dir/phones/word_boundary.txt \
...
/root/k0/egs/Capstone_ASR/utils/gen_topo.pl $num_nonsil_states $num_sil_states $nonsilphonelist $silphonelist >$dir/topo
...
if $silprob; then
  /root/k0/egs/Capstone_ASR/utils/lang/make_lexicon_fst_silprob.py $grammar_opts \
  ...
  /root/k0/egs/Capstone_ASR/utils/lang/make_lexicon_fst.py $grammar_opts \
...
if [ ! -z "$unk_fst" ]; then
  /root/k0/egs/Capstone_ASR/utils/lang/internal/apply_unk_lm.sh $unk_fst $dir || exit 1
...
! /root/k0/egs/Capstone_ASR/utils/validate_lang.pl $dir && echo "$(basename $0): error validating output" &&  exit 1;

...
/root/k0/egs/Capstone_ASR/steps/diagnostic/analyze_alignments.sh --cmd "$cmd" $lang $dir
/root/k0/egs/Capstone_ASR/utils/summarize_warnings.pl $dir/log

/root/k0/egs/Capstone_ASR/steps/info/gmm_dir_info.pl $dir

...
nj=4
cmd=/root/k0/egs/Capstone_ASR/utils/run.pl
mfcc_config=/root/k0/egs/Capstone_ASR/conf/mfcc.conf
compress=true
...
if [ -f path.sh ]; then . /root/k0/egs/Capstone_ASR/path.sh; fi
...
/root/k0/egs/Capstone_ASR/utils/validate_data_dir.sh --no-text --no-feats $data || exit 1;
...
for n in $(seq $nj); do
  ...
  /root/k0/egs/Capstone_ASR/utils/create_data_link.pl $mfccdir/raw_mfcc_$name.$n.ark
done
...
if [ -f $data/segments ]; then
  ...
  /root/k0/egs/Capstone_ASR/utils/split_scp.pl $data/segments $split_segments || exit 1;
  ...
  /root/k0/egs/Capstone_ASR/utils/split_scp.pl $scp $split_scps || exit 1;

...
if [ $stage -le 1 ]; then
  ...
  for wip in $(echo $word_ins_penalty | sed 's/,/ /g'); do
    for lmwt in $(seq $min_lmwt $max_lmwt); do
      ...
      grep WER $dir/wer_${lmwt}_${wip} /root/k0/egs/Capstone_ASR/data/dev/null
    done
  done | /root/k0/egs/Capstone_ASR/utils/best_wer.sh  >& $dir/scoring_kaldi/best_wer || exit 1
  ...
  if $stats; then
    ...
    $cmd $dir/scoring_kaldi/log/stats1.log \
      ...
      /root/k0/egs/Capstone_ASR/utils/scoring/wer_per_utt_details.pl --special-symbol "'***'" \| tee $dir/scoring_kaldi/wer_details/per_utt \|\
       /root/k0/egs/Capstone_ASR/utils/scoring/wer_per_spk_details.pl $data/utt2spk \> $dir/scoring_kaldi/wer_details/per_spk || exit 1;

    $cmd $dir/scoring_kaldi/log/stats2.log \
      cat $dir/scoring_kaldi/wer_details/per_utt \| \
      /root/k0/egs/Capstone_ASR/utils/scoring/wer_ops_details.pl --special-symbol "'***'" \| \
